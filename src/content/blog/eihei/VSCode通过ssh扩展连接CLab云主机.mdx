...
![推送部分内容截图](	/figures/37ztprtrxb4ec4p6jn.png)<br>
...
![示例图片1](	/figures/unqkkctmmw1ovv38af.png)

#### 二. 连接主机
1. 首先点击左侧出现的图标，然后选择"隧道/SSH"

![示例图片2](/figures/9rhza7ceys66kajmyc.png)

2. 生成`config`文件

点击SSH栏的小齿轮,选中第一个路径即可

![示例图片3](/figures/1ba7z35ywnnpcbi1k7.png)

3. 修改`config`文件

![示例图片4](/figures/bvjar6bw5hfrgnc3lt.png)
...
![示例图片5](	/figures/zbaj7975n8tpgjvekz.png)
