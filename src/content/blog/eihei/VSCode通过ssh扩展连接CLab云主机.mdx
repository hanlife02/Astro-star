...
description: "记录使用 VS Code Remote SSH 连接 CLab 云主机的流程，包括密钥保存、config 配置与免密远程开发。"
...
![推送部分内容截图](/figures/021-VSCode通过ssh扩展连接CLab云主机.png)<br>
...
![示例图片1](/figures/022-VSCode通过ssh扩展连接CLab云主机.png)

#### 二. 连接主机

1. 首先点击左侧出现的图标，然后选择"隧道/SSH"

![示例图片2](/figures/023-VSCode通过ssh扩展连接CLab云主机.png)

2. 生成`config`文件

点击SSH栏的小齿轮,选中第一个路径即可

![示例图片3](/figures/024-VSCode通过ssh扩展连接CLab云主机.png)

3. 修改`config`文件

![示例图片4](/figures/025-VSCode通过ssh扩展连接CLab云主机.png)
...
![示例图片5](/figures/026-VSCode通过ssh扩展连接CLab云主机.png)
