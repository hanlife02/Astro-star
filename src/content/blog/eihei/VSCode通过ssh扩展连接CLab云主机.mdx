...
![推送部分内容截图](./images/021-VSCode通过ssh扩展连接CLab云主机.png)<br>
...
![示例图片1](./images/022-VSCode通过ssh扩展连接CLab云主机.png)

#### 二. 连接主机

1. 首先点击左侧出现的图标，然后选择"隧道/SSH"

![示例图片2](./images/023-VSCode通过ssh扩展连接CLab云主机.png)

2. 生成`config`文件

点击SSH栏的小齿轮,选中第一个路径即可

![示例图片3](./images/024-VSCode通过ssh扩展连接CLab云主机.png)

3. 修改`config`文件

![示例图片4](./images/025-VSCode通过ssh扩展连接CLab云主机.png)
...
![示例图片5](./images/026-VSCode通过ssh扩展连接CLab云主机.png)
