...
legacySourceId: "66d2b652bc2b398e402c6550"
---
...
![推送部分内容截图](	/legacy-assets/37ztprtrxb4ec4p6jn.png)<br>
...
![示例图片1](	/legacy-assets/unqkkctmmw1ovv38af.png)

#### 二. 连接主机
1. 首先点击左侧出现的图标，然后选择"隧道/SSH"

![示例图片2](/legacy-assets/9rhza7ceys66kajmyc.png)

2. 生成`config`文件

点击SSH栏的小齿轮,选中第一个路径即可

![示例图片3](/legacy-assets/1ba7z35ywnnpcbi1k7.png)

3. 修改`config`文件

![示例图片4](/legacy-assets/bvjar6bw5hfrgnc3lt.png)
...
![示例图片5](	/legacy-assets/zbaj7975n8tpgjvekz.png)
