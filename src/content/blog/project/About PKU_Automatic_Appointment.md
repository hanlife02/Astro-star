...
一个供北大学生使用的自动预约脚本<br><br>

[仓库地址](https://github.com/hanlife02/PKU_Automatic_Appointment)
...
①  ~~建议门户绑定微信公众号，弹窗有一定几率导致失败(经测试失败概率不高，但仍然存在)~~ <br>
...
见到下图即运行成功<br><br>
![示例图片2](https://hanlife02.com/api/v2/objects/file/2dhy73n26f3nd2ct6k.png)
<br><br>
