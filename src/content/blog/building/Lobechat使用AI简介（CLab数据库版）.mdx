...
![注册页面](./images/070-Lobechat使用AI简介-CLab数据库版.png)
...
![token](./images/071-Lobechat使用AI简介-CLab数据库版.png)
...
![创建令牌](./images/072-Lobechat使用AI简介-CLab数据库版.png)
...
![GitHub](./images/073-Lobechat使用AI简介-CLab数据库版.png)
...
![自定义服务商](./images/074-Lobechat使用AI简介-CLab数据库版.png)

#### 3 · Gemini的配置

找到google服务商，直接添加key即可

![Gemini!](./images/075-Lobechat使用AI简介-CLab数据库版.png)
...
![选择对应模型](./images/076-Lobechat使用AI简介-CLab数据库版.png)
