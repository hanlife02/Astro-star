...
description: "介绍在 CLab 上部署数据库版 LobeChat 的使用方式，包括校园网访问、账号注册、API 密钥配置与模型服务接入。"
...
![注册页面](/figures/070-Lobechat使用AI简介-CLab数据库版.png)
...
![token](/figures/071-Lobechat使用AI简介-CLab数据库版.png)
...
![创建令牌](/figures/072-Lobechat使用AI简介-CLab数据库版.png)
...
![GitHub](/figures/073-Lobechat使用AI简介-CLab数据库版.png)
...
![自定义服务商](/figures/074-Lobechat使用AI简介-CLab数据库版.png)

#### 3 · Gemini的配置

找到google服务商，直接添加key即可

![Gemini!](/figures/075-Lobechat使用AI简介-CLab数据库版.png)
...
![选择对应模型](/figures/076-Lobechat使用AI简介-CLab数据库版.png)
